...
Module Utils
    ...
    Sub auto_GSRV_TMIR(ByVal hostName As String, ByVal userName As String, ByVal password As String, ByVal cdcStr As String, ByVal inicTimeStr As String, ByVal finTimeStr As String, ByRef errCodeInt As Integer, ByRef errMessageStr As String)
        ...
        errCodeInt = sentStringToSSHUntilMatch(ssh, "11", "Enter Selection:", channelNum, pollTimeoutMs, cmdOutputStr, msgError)
        If errCodeInt <> 0 Then
            errCodeInt = -9
            errMessageStr = ssh.LastErrorText
            Exit Sub
        ...
        errCodeInt = sentStringToSSHUntilMatch(ssh, "02", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError)
        If errCodeInt <> 0 Then
            errCodeInt = -9
            errMessageStr = ssh.LastErrorText
            Exit Sub
        ...
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'CDC
        Sleep(1000)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Is the MJF file on tape [N] 
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'TMIR report name [/oltp/prosys/gsrv/reports/tmir.rep] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "2", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Select option 1:Detailed   2:Summary only [1] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Selection by transaction type [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Do you want to include types >= 82 [Y] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Select by journal address [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Selection by serial number [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Selection by product number [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "Y", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Selection by terminal idn [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "11107600", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Enter lowest terminal idn [1] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "11107603", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Enter highest terminal idn [11107600] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Selection by teller [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "Y", ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Selection by time [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, inicTimeStr, ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Enter lowest time (hh:mm:ss) [00:00:00] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, finTimeStr, ">", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Enter highest time (hh:mm:ss) [00:00:00] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", "Press any key to return to the menu...", channelNum, pollTimeoutMs, cmdOutputStr, msgError) 'Do you wish to calculate trans size stats [N] >
        Sleep(1000)
        'MsgBox(cmdOutputStr)
        errCodeInt = sentStringToSSHUntilMatch(ssh, "", "Enter Selection:", channelNum, pollTimeoutMs, cmdOutputStr, msgError)
        'Sleep(1000)
        ''MsgBox(cmdOutputStr)
        ...
        '/oltp/prosys/gsrv/reports/tmir.rep


        If errCodeInt = 0 Then

            strPathRemoteFile = "/oltp/prosys/gsrv/reports/tmir.rep"
            strPathFile = "H:\tmir.rep"
